...
namespace AllForTheHackathon.Migrations
{
    ...
    [Migration("20240929160943_Initial")]
            ...
            modelBuilder.Entity("AllForTheHackathon.Domain.Team", b =>
                {
                    ...
                    b.HasOne("AllForTheHackathon.Domain.Employees.Junior", "Junior")
                        .WithMany()
                        .HasForeignKey("JuniorId");

                    b.HasOne("AllForTheHackathon.Domain.Employees.TeamLead", "TeamLeader")
                        .WithMany()
